...
public class Selec_destino extends javax.swing.JFrame {
    ...
    private void jFileChooser3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jFileChooser3ActionPerformed
         ...
         {      
          PlanCrear.txtDestino.setText(jFileChooser3.getSelectedFile().toPath().toString()+ "");
          System.out.println("-Modificado Destino ---------");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Selec_destino.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Selec_destino().setVisible(true);
            }
        });
    }
